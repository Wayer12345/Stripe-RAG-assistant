"""Application-layer wrapper for context eval mode."""
...
class RunContextEvalLayer:
    ...
    def run(self) -> EvalRunExecutionResult:
        ...
        log_metrics_summary(
            logger_name=logger,
            title="Context eval metrics summary:",
            metrics=metrics,
            metric_paths={
                "context_chunk_recall": "context.context_chunk_recall_mean",
                "context_document_recall": "context.context_document_recall_mean",
                "context_url_recall": "context.context_url_recall_mean",
                "expected_chunk_dropped_rate": "context.expected_chunk_dropped_rate_mean",
                "token_budget_violation": "context.token_budget_violation_mean",
                "truncated": "context.truncated_mean",
                "empty_context": "context.empty_context_mean",
                "dedup_rate": "context.dedup_rate_mean",
                "avg_context_tokens": "context.avg_context_tokens_mean",
                "retrieval_chunk_recall_at_10": "retrieval.chunk_recall_at_10_mean",
                "rerank_mrr_delta": "rerank.mrr_delta_mean",
                "rerank_kept_rate": "rerank.kept_rate_mean",
                "retrieve_p95_ms": "latency.retrieve_p95_ms",
                "rerank_p95_ms": "latency.rerank_p95_ms",
                "context_mean_ms": "latency.context_mean_ms",
...
def _build_arg_parser() -> argparse.ArgumentParser:
    parser = build_base_eval_arg_parser("Run context eval on a dataset.")
