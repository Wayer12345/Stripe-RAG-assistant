"""Application-layer wrapper for robustness eval mode."""
...
class RunRobustnessEvalLayer:
    ...
    def run(self) -> EvalRunExecutionResult:
        ...
        log_metrics_summary(
            logger_name=logger,
            title="Robustness eval metrics summary:",
            metrics=metrics,
            metric_paths={
                "ood_abstained": "robustness.ood_abstained_mean",
                "unanswerable_unsupported_answer": "robustness.unanswerable_unsupported_answer_mean",
                "typo_answered": "robustness.typo_answered_mean",
                "ambiguous_safe": "robustness.ambiguous_safe_mean",
                "adversarial_valid_sources": "robustness.adversarial_valid_sources_mean",
...
def _build_arg_parser() -> argparse.ArgumentParser:
    parser = build_base_eval_arg_parser("Run robustness eval on a dataset.")
